...
const UnderConstruction = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#051A37] text-[#FFB9B8]">
      ...
      <div className="mt-4">
        <p className="text-[10px]">© {new Date().getFullYear()} Puzle Consultora. Todos los derechos reservados.</p>
      </div>
    </div>
  );
};
